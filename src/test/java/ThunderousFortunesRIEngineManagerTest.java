...
public class ThunderousFortunesRIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThunderousFortunesRIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThunderousFortunesRIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThunderousFortunesRIIW/InitOutcome.xml").getDocumentElement();
